#!/bin/bash
#SBATCH --job-name=h100_blue_suv_3st9k
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=50G
#SBATCH --time=02:30:00
#SBATCH --output=jobs_with_sam3D/logs/h100_blue_suv_3st9k_%j.out
#SBATCH --error=jobs_with_sam3D/logs/h100_blue_suv_3st9k_%j.err
...
python main.py \
  ...
  --azim_max 360 \
  --elev_max 60 \
  --output_path ./jobs_with_sam3D/outputs/blueberry_to_santafe_prompt_suv_target_three_stage_9000_${SLURM_JOB_ID:-manual} \
  --epochs 9000
