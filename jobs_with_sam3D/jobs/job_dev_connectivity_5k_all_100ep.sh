#!/bin/bash
#SBATCH --job-name=dev_conn5k_all_100ep
#SBATCH --partition=dev_gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=120G
#SBATCH --time=00:30:00
#SBATCH --output=jobs_with_sam3D/logs/dev_conn5k_all_100ep_%j.out
#SBATCH --error=jobs_with_sam3D/logs/dev_conn5k_all_100ep_%j.err
...
echo "======================================================"
echo "DEV CONNECTIVITY CHECK (ALL MESHES): 100 epochs each"
echo "======================================================"
...
for mesh_path in "${meshes[@]}"; do
  ...
  python main.py \
    ...
    --azim_max 350 \
    --elev_max 35 \
    --output_path "./jobs_with_sam3D/outputs/connectivity_100ep_${mesh_name}_${SLURM_JOB_ID:-manual}" \
    --epochs 100
done

echo "END_TIME=$(date)"
echo "Finished connectivity check for all meshes"
