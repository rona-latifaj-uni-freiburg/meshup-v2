#!/bin/bash
#SBATCH --job-name=h100_hound_hippo_bigears
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=120G
#SBATCH --time=08:00:00
#SBATCH --output=jobs_with_sam3D/logs/h100_hound_hippo_bigears_%j.out
#SBATCH --error=jobs_with_sam3D/logs/h100_hound_hippo_bigears_%j.err
...
echo "======================================================"
echo "H100 RUN: hound -> hippo (target mesh + DINO)"
echo "======================================================"
...
python main.py \
  ...
  --azim_max 350 \
  --elev_max 35 \
  --output_path ./jobs_with_sam3D/outputs/hound_to_hippo_bigears_h100_${SLURM_JOB_ID:-manual} \
  --epochs 3000

echo "END_TIME=$(date)"
echo "Finished H100 hound -> hippo run"
