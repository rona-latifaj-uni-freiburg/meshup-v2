#!/bin/bash
#SBATCH --job-name=h100_blueberry_bugatti
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=120G
#SBATCH --time=08:00:00
#SBATCH --output=jobs_with_sam3D/logs/h100_blueberry_bugatti_%j.out
#SBATCH --error=jobs_with_sam3D/logs/h100_blueberry_bugatti_%j.err
...
echo "======================================================"
echo "H100 RUN: blueberry -> bugatti (DINO + target mesh)"
echo "======================================================"
...
python main.py \
  ...
  --azim_max 350 \
  --elev_max 35 \
  --output_path ./jobs_with_sam3D/outputs/blueberry_to_bugatti_h100_${SLURM_JOB_ID:-manual} \
  --epochs 3500

echo "END_TIME=$(date)"
echo "Finished H100 blueberry -> Bugatti run"
