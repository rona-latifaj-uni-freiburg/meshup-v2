#!/bin/bash
#SBATCH --job-name=eval_bulldog
#SBATCH --partition=dev_gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=40G
#SBATCH --time=00:30:00
#SBATCH --output=experiments/dog_morphs/slurm_logs/eval_bulldog_%j.out
#SBATCH --error=experiments/dog_morphs/slurm_logs/eval_bulldog_%j.err
...
OUTPUT_DIR="./experiments/dog_morphs/outputs/hound_to_bulldog_exp"
