...
#SBATCH --output=jobs_with_target_guidance/latent_soft_runs/logs/dev_pf_lat2500_%j.out
#SBATCH --error=jobs_with_target_guidance/latent_soft_runs/logs/dev_pf_lat2500_%j.err
