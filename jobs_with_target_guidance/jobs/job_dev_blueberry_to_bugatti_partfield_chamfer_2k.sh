#!/bin/bash
#SBATCH --job-name=dev_blue_bug_pf2k
#SBATCH --partition=dev_gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=50G
#SBATCH --time=00:30:00
#SBATCH --output=jobs_with_target_guidance/logs/dev_blue_bug_pf2k_%j.out
#SBATCH --error=jobs_with_target_guidance/logs/dev_blue_bug_pf2k_%j.err
...
LABEL=blueberry_to_bugatti_sportscar_2k_dev
PROMPT="a sports car"
...
echo "======================================================"
echo "DEV H100 blueberry -> Bugatti PartField target Chamfer, ${EPOCHS} epochs"
echo "SOURCE=${SOURCE}"
echo "PROMPT=${PROMPT}"
echo "TARGET=${TARGET}"
