#!/bin/bash
#SBATCH --job-name=h100_vint_bug_pf7k
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=50G
#SBATCH --time=03:00:00
#SBATCH --output=jobs_with_target_guidance/logs/h100_vint_bug_pf7k_%j.out
#SBATCH --error=jobs_with_target_guidance/logs/h100_vint_bug_pf7k_%j.err
...
SOURCE=./jobs_with_sam3D/meshes/5k_upright_wheels_down/vintage_car_5k_upright_wheels_down.ply
TARGET=./jobs_with_sam3D/meshes/5k_upright_wheels_down/bugatti-centodieci_5k_upright_wheels_down.ply
LABEL=vintage_car_to_bugatti_7k
PROMPT="a sports car"
...
SOURCE_PARTFIELD_LABELS=${SOURCE_PARTFIELD_LABELS:-${PARTFIELD_LABEL_DIR}/vintage_car_partfield_labels.npz}
TARGET_PARTFIELD_LABELS=${TARGET_PARTFIELD_LABELS:-${PARTFIELD_LABEL_DIR}/bugatti_partfield_labels.npz}
SOURCE_PARTFIELD_COLORED=${SOURCE_PARTFIELD_COLORED:-${PARTFIELD_SEGMENT_DIR}/colored/vintage_car_partfield_12_parts.ply}
TARGET_PARTFIELD_COLORED=${TARGET_PARTFIELD_COLORED:-${PARTFIELD_SEGMENT_DIR}/colored/bugatti_partfield_12_parts.ply}
...
echo "======================================================"
echo "H100 Vintage -> Bugatti PartField target Chamfer, ${EPOCHS} epochs"
echo "SOURCE=${SOURCE}"
echo "PROMPT=${PROMPT}"
echo "TARGET=${TARGET}"
