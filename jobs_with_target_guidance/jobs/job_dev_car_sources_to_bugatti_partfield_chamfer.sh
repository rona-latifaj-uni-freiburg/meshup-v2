#!/bin/bash
#SBATCH --job-name=h100_blue_bug_pf7k
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=50G
#SBATCH --time=03:00:00
#SBATCH --output=jobs_with_target_guidance/logs/h100_blue_bug_pf7k_%j.out
#SBATCH --error=jobs_with_target_guidance/logs/h100_blue_bug_pf7k_%j.err
...
LABEL=blueberry_to_bugatti_sportscar_7k
PROMPT="a sports car"
...
echo "======================================================"
echo "H100 blueberry -> Bugatti PartField target Chamfer, 7000 epochs"
echo "SOURCE=${SOURCE}"
echo "PROMPT=${PROMPT}"
echo "TARGET=${TARGET}"
