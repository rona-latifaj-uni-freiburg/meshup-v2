#!/bin/bash
#SBATCH --job-name=dev_blue_car_ab2k
...
#SBATCH --array=0-7
#SBATCH --output=jobs_with_target_guidance/logs/dev_blue_car_ab2k_%A_%a.out
#SBATCH --error=jobs_with_target_guidance/logs/dev_blue_car_ab2k_%A_%a.err
...
EPOCHS=2000
VARIANT=baseline12
PARTFIELD_SEGMENT_DIR=./jobs_with_target_guidance/partfield_segments/car_5k
...
case "${VARIANT_ID}" in
  ...
  1)
    VARIANT=buckets20
    N_BUCKETS=20
    PARTFIELD_SEGMENT_DIR=./jobs_with_target_guidance/partfield_segments/car_5k_20
    ;;
  2)
    VARIANT=soft_pf12
...
echo "======================================================"
echo "DEV blueberry-source PartField ablation, task ${TASK_ID}, ${EPOCHS} epochs"
