#!/bin/bash
#SBATCH --job-name=dev_dach_pit_pf2k
#SBATCH --partition=dev_gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=50G
#SBATCH --time=00:30:00
#SBATCH --output=jobs_with_target_guidance/logs/dev_dach_pit_pf2k_%j.out
#SBATCH --error=jobs_with_target_guidance/logs/dev_dach_pit_pf2k_%j.err
...
LABEL=dachshund_to_pitbull_2k_dev
PROMPT="a dog"
...
SOURCE_PARTFIELD_LABELS=${SOURCE_PARTFIELD_LABELS:-${PARTFIELD_LABEL_DIR}/hound_to_dachshund_partfield_labels.npz}
TARGET_PARTFIELD_LABELS=${TARGET_PARTFIELD_LABELS:-${PARTFIELD_LABEL_DIR}/hound_to_bulldog_partfield_labels.npz}
SOURCE_PARTFIELD_COLORED=${SOURCE_PARTFIELD_COLORED:-${PARTFIELD_SEGMENT_DIR}/colored/hound_to_dachshund_partfield_20_parts.ply}
TARGET_PARTFIELD_COLORED=${TARGET_PARTFIELD_COLORED:-${PARTFIELD_SEGMENT_DIR}/colored/hound_to_bulldog_partfield_20_parts.ply}
...
echo "======================================================"
echo "DEV H100 dachshund -> pitbull/bulldog PartField target Chamfer, ${EPOCHS} epochs"
echo "SOURCE=${SOURCE}"
echo "PROMPT=${PROMPT}"
echo "TARGET=${TARGET}"
