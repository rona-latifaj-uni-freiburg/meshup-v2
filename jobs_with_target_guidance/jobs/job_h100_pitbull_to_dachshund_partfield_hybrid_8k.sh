#!/bin/bash
#SBATCH --job-name=h100_pit_pfhy8k
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=50G
#SBATCH --time=02:30:00
#SBATCH --output=jobs_with_target_guidance/logs/h100_pit_pfhy8k_%j.out
#SBATCH --error=jobs_with_target_guidance/logs/h100_pit_pfhy8k_%j.err
...
LABEL=pitbull_to_dachshund_hybrid_8k
...
echo "======================================================"
echo "H100 pitbull/bulldog -> dachshund PartField hybrid guidance, ${EPOCHS} epochs"
echo "SOURCE=${SOURCE}"
echo "PROMPT=${PROMPT}"
echo "TARGET=${TARGET}"
